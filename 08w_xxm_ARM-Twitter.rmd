...
Search<-twitteR::searchTwitter("delegates",n=900,since="2020-03-02")
...
wordcloud(d$word,d$freq, colors=c("red","green","blue","orange","black","purple", "seagreen") , random.color = TRUE, min.freq = 50)
...
wordcloud(d$word,d$freq, colors=c("red","green","blue","orange","black","purple", "seagreen") , random.color = TRUE, min.freq = 90)
...
plot (head(SortedRules_sup,n=4),method="graph",shading="confidence") 
plot (head(SortedRules_conf, n=4),method="graph", shading="confidence") 
