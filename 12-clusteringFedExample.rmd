...
Next we will add the clustering results back to the dataframe and display the findings. 
...
Below we display the results of HAC.
...
HAC2 <- hclust(distance6, method="single")
plot(HAC2, cex=0.6)
rect.hclust(HAC, k =4, border=2:5)
